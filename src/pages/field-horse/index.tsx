...
import Profile from '@/components/field-horse/profile';
...
const FieldPage: NextPageWithLayout<
...
> = () => {
  ...
  if (layout === LAYOUT_OPTIONS.RETRO) {
    ...
    return (
      <>
        <NextSeo title="Field" description="Freedom - Web3 NFT Game" />
...
FieldPage.getLayout = function getLayout(page) {
